...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 31, 2022 at 11:09 AM
...
INSERT INTO `amphur` (`id`, `code`, `name`, `geo_id`, `province_id`) VALUES
...
INSERT INTO `coffee` (`id`, `code`, `name`, `description`, `image`, `status`) VALUES
(1, '61143099', 'เอสเปรสโซ่', NULL, 'menu_2_เอสเปรสโซ่.jpg', 'use'),
(2, '98153995', 'คาปูชิโน่', NULL, 'menu_2_คาปูชิโน่.jpg', 'use'),
(3, '47734197', 'เลม่อนโซดา', NULL, 'menu_2_เลม่อนโซดา.jpg', 'use'),
(4, '60097130', 'บลูฮาวาย', NULL, 'menu_2_บลูฮาวาย.jpg', 'use'),
(5, '88698995', 'แอปเปิ้ลโซดา', NULL, 'menu_2_แอปเปิ้ลโซดา.jpg', 'use');
...
INSERT INTO `coffeeshop` (`id`, `name`, `address`, `tel`, `facebook`, `website`) VALUES
(1, 'ร้านของฉัน', '123 ม.5', '0987654321', NULL, 'website');

-- --------------------------------------------------------

--
-- Table structure for table `coffeesize`
--
...
--
-- Dumping data for table `coffeesize`
--

INSERT INTO `coffeesize` (`id`, `code`, `size_name`, `remark`, `status`) VALUES
(1, '1001', 'เล็ก', NULL, 'use'),
(2, '1002', 'กลาง', NULL, 'use'),
(3, '1003', 'ใหญ่', NULL, 'use');
...
INSERT INTO `coffeetype` (`id`, `code`, `type_name`, `remark`, `status`) VALUES
(1, '1001', 'ร้อน', NULL, 'use'),
(2, '1002', 'เย็น', NULL, 'use'),
(3, '1003', 'ปั่น', NULL, 'use');
...
INSERT INTO `customer` (`id`, `name`, `email`, `address`, `tel`, `tax_id`, `line`, `remark`, `username`, `password`, `status`, `province_id`, `amphur_id`, `district_id`, `created_date`) VALUES
(1, 'วันชนะ', NULL, '1234', '099-067-6734', '1-3503-00083-0-80', NULL, NULL, 'aoffy', '123456', 'use', 23, 319, 2886, '2022-03-26');
...
INSERT INTO `district` (`id`, `code`, `name`, `amphur_id`, `province_id`, `geo_id`) VALUES
...
INSERT INTO `price` (`id`, `size_id`, `type_id`, `coffee_id`, `price`, `status`) VALUES
(1, 1, 1, 1, 25.0000, 'use'),
(2, 1, 2, 1, 35.0000, 'use'),
(3, 1, 3, 1, 45.0000, 'use'),
(4, 2, 1, 1, 35.0000, 'use'),
...
(8, 3, 2, 1, 55.0000, 'use'),
(9, 3, 3, 1, 65.0000, 'use'),
(10, 2, 1, 2, 50.0000, 'use'),
(11, 2, 2, 2, 55.0000, 'use'),
(12, 2, 3, 2, 60.0000, 'use'),
(13, 3, 1, 2, 60.0000, 'use'),
(14, 3, 2, 2, 65.0000, 'use'),
(15, 3, 3, 2, 70.0000, 'use'),
(16, 2, 2, 3, 50.0000, 'use'),
(17, 3, 2, 3, 60.0000, 'use'),
(18, 2, 3, 3, 70.0000, 'use'),
(19, 3, 3, 3, 80.0000, 'use'),
(20, 2, 2, 4, 50.0000, 'use'),
(21, 2, 3, 4, 60.0000, 'use'),
(22, 3, 2, 4, 70.0000, 'use'),
(23, 3, 3, 4, 80.0000, 'use'),
(24, 1, 2, 5, 30.0000, 'use'),
(25, 1, 3, 5, 40.0000, 'use'),
(26, 2, 2, 5, 40.0000, 'use'),
(27, 2, 3, 5, 50.0000, 'use'),
(28, 3, 2, 5, 50.0000, 'use'),
(29, 3, 3, 5, 60.0000, 'use');
...
INSERT INTO `province` (`id`, `code`, `name`, `geo_id`) VALUES
...
CREATE TABLE `sale` (
  ...
  `totalSale` double(15,4) NOT NULL,
  `sale_by` enum('online','cafe') DEFAULT NULL,
  `user_id` int(11) NOT NULL,
  `customer_id` int(11) NOT NULL,
  `remark` varchar(255) DEFAULT NULL,
  `order_code` varchar(50) DEFAULT NULL,
  `status` enum('use','delete','confirm','wait') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `sale` (`id`, `date`, `discount`, `totalSale`, `sale_by`, `user_id`, `customer_id`, `remark`, `order_code`, `status`) VALUES
(1, '2022-03-28 01:12:47', 0.0000, 330.0000, 'online', 14, 1, NULL, '20220328-1', 'use'),
(2, '2022-03-28 20:12:01', 0.0000, 225.0000, 'online', 14, 1, NULL, '20220328-637570', 'confirm');
...
CREATE TABLE `sale_detail` (
  ...
  `itemPrice` double(15,4) NOT NULL DEFAULT '0.0000',
  `status` enum('use','delete','wait') NOT NULL DEFAULT 'use'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `sale_detail` (`customer_id`, `id`, `sale_id`, `coffee_id`, `price_id`, `amount`, `discount`, `itemPrice`, `status`) VALUES
(1, 1, 1, 1, 1, 2, 0.0000, 50.0000, 'use'),
(1, 2, 1, 4, 20, 1, 0.0000, 65.0000, 'use'),
(1, 3, 1, 4, 20, 1, 0.0000, 65.0000, 'use'),
(1, 4, 1, 3, 16, 2, 0.0000, 150.0000, 'use'),
(1, 5, 2, 3, 16, 2, 0.0000, 130.0000, 'use'),
(1, 6, 2, 3, 16, 1, 0.0000, 55.0000, 'use'),
(1, 7, 2, 5, 26, 1, 0.0000, 40.0000, 'use');

-- --------------------------------------------------------

--
-- Table structure for table `sale_toppping`
--

CREATE TABLE `sale_toppping` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `sale_toppping`
--

INSERT INTO `sale_toppping` (`id`, `topping_id`, `sale_detail_id`, `price`, `status`) VALUES
(1, 7, 3, 5.0000, 'use'),
(2, 2, 3, 10.0000, 'use'),
(3, 2, 4, 10.0000, 'use'),
(4, 7, 4, 5.0000, 'use'),
...
INSERT INTO `topping` (`id`, `code`, `name`, `price`, `status`) VALUES
(1, '1001', 'เพิ่มนม', 10.0000, 'use'),
(2, '1002', 'เพิ่มหวาน', 10.0000, 'use'),
(3, '1003', 'เพิ่มช้อต', 10.0000, 'delete'),
(4, '1003', 'กาแฟช็อต', 20.0000, 'use'),
(5, '1004', 'เจลลี่', 10.0000, 'use'),
(6, '1005', 'ไข่มุก', 5.0000, 'use'),
(7, '1006', 'วุ้น 3 สี', 5.0000, 'use');

-- --------------------------------------------------------

--
-- Table structure for table `toppingtocoffee`
--

CREATE TABLE `toppingtocoffee` (
  `id` int(11) NOT NULL,
  `topping_id` int(11) NOT NULL,
  `coffee_id` int(11) NOT NULL,
  `status` enum('use','delete') NOT NULL DEFAULT 'use'
...
--
-- Dumping data for table `toppingtocoffee`
--

INSERT INTO `toppingtocoffee` (`id`, `topping_id`, `coffee_id`, `status`) VALUES
(3, 3, 1, 'use'),
(4, 2, 1, 'use'),
(5, 2, 0, 'delete'),
(7, 4, 2, 'use'),
...
CREATE TABLE `user` (
  ...
  `level` varchar(50) NOT NULL DEFAULT 'cacheer' COMMENT 'ระดับผู้ใช้งาน',
...
INSERT INTO `user` (`id`, `name`, `tel`, `email`, `level`, `username`, `password`, `address`, `status`) VALUES
(15, 'testtttt', '0987654321', 'email@re.com', 'admin', 'tesst', '123456', '123 ม.5', 'remove'),
(14, 'admin', '0987654321', 'example@gmail.com', 'admin', 'admin', '1234', 'test addresdss', 'use');
...
--
-- Indexes for table `coffeesize`
--
ALTER TABLE `coffeesize`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `sale_toppping`
--
ALTER TABLE `sale_toppping`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `toppingtocoffee`
--
ALTER TABLE `toppingtocoffee`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `coffeesize`
--
ALTER TABLE `coffeesize`
...
--
ALTER TABLE `district`
  MODIFY `id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8861;
...
--
-- AUTO_INCREMENT for table `sale_toppping`
--
ALTER TABLE `sale_toppping`
...
--
-- AUTO_INCREMENT for table `toppingtocoffee`
--
ALTER TABLE `toppingtocoffee`
